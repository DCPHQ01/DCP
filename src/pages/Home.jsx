        ...
        <section className="section-padding px-8 my-12 sm:px-30" id="csr">
          <div className="sec4-container mx-auto">
            ...
            <div className="w-full text-center justify-items-center grid grid-cols-1 sm:grid-cols-2 gap-8 mt-8 relative">
              {/* Cards */}
              <div className={`${paddingSec4} animate__animated animate__fadeInUp`} data-wow-delay="0.4s">
                ...
                <p className={`${sec4p} text-justify`}>DCP’s LEAP Program builds human capital by offering practical training in entrepreneurship, digital skills, and workplace readiness for students, graduates, corps members, and emerging leaders. Participants gain real-world experience to boost their careers and support national development.</p>
              </div>

              <div className={`${paddingSec4} animate__animated animate__fadeInUp`} data-wow-delay="0.6s">
